...
| [moica-revocation-smt](https://github.com/privacy-ethereum/moica-revocation-smt) | MOICA CRL → Poseidon SMT → REST/gRPC proofs → on-chain root (Arbitrum Sepolia `0xc461…AFFA`); binary snapshots for offline client use | — | [`b9e272d`](https://github.com/privacy-ethereum/moica-revocation-smt/commit/b9e272d55a9f1fabe92b20d17b2e4bf682413217) |
